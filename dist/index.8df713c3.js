...
})({"2XMnT":[function(require,module,exports) {
...
},{}],"4WM95":[function(require,module,exports) {
require('./bundle-manifest').register(JSON.parse("{\"4jSPC\":\"index.8df713c3.js\",\"1oCTM\":\"invisible_man.2de87ba5.txt\",\"2cF7r\":\"IM_19_by_20_try_2.486cb12b.csv\"}"));
...
},{}],"435K3":[function(require,module,exports) {
"use strict";
...
class Freq {
  ...
  draw(newWord) {
    ...
    const smallFont = 12;
    this.svg = d3.select("#d3-container-freq").append("svg").attr("class", "freq").attr("viewBox", [0, 0, width, height * 1.1]);
    ...
    this.xAxis = d3.axisBottom(this.xScale).tickValues(this.chapterTicksObj.map(a => a.num)).tickSize(-height).tickFormat(function (d, i) {
      return chArray[i];
    }); // .tickFormat("");
  ...
  updateFreq(newWord) {
    ...
    const circle = this.svg.selectAll("circle").data(this.keysNum).join("circle").attr("class", "circle").attr("cy", this.yScale(5)).attr("cx", d => this.xScale(d)).attr("r", radius).attr("fill", paleWhite).attr("opacity", 1).attr("stroke", paleWhite).on("mouseenter", function (d) {
      ...
      this.dispatch.call("scroll", this, d); // dispatches the word number to context
  ...
  drawFreqMulti() {
    ...
    const marginRight = 10;
    const marginBottom = 0;
    this.multiSvg = d3.select("#d3-container-freq2").append("svg").attr("class", "freqMulti").attr("viewBox", [0, 0, width, height * 1.1]);
    ...
    this.multiSvg.attr("class", "freq2").append("g").attr("transform", `translate(0, ${height - marginBottom})`).call(this.xAxis); // .append("text")
...
},{"d3-array":"7Gn4R","d3-axis":"7ep8H","d3-brush":"vkfkp","d3-chord":"7hQoW","d3-color":"1kl75","d3-contour":"1C8dn","d3-delaunay":"7KMvU","d3-dispatch":"3ftnw","d3-drag":"2zUEx","d3-dsv":"3BqSm","d3-ease":"3yJiC","d3-fetch":"5pIjH","d3-force":"4Ooqu","d3-format":"5jKH7","d3-geo":"p8dTK","d3-hierarchy":"RTbkJ","d3-interpolate":"6RoOu","d3-path":"3vIq9","d3-polygon":"1mhHE","d3-quadtree":"64Qok","d3-random":"17JQ6","d3-scale":"7DG2y","d3-scale-chromatic":"3Z2qd","d3-selection":"5pkuM","d3-shape":"1Bd3C","d3-time":"4tlEX","d3-time-format":"37Crq","d3-timer":"6PMnx","d3-transition":"6SBVd","d3-zoom":"7FW9c"}],"7Gn4R":[function(require,module,exports) {
var define;
...
},{}],"7ep8H":[function(require,module,exports) {
var define;
...
},{}],"vkfkp":[function(require,module,exports) {
var define;
...
},{"d3-dispatch":"3ftnw","d3-drag":"2zUEx","d3-interpolate":"6RoOu","d3-selection":"5pkuM","d3-transition":"6SBVd"}],"3ftnw":[function(require,module,exports) {
var define;
...
},{}],"2zUEx":[function(require,module,exports) {
var define;
...
},{"d3-dispatch":"3ftnw","d3-selection":"5pkuM"}],"5pkuM":[function(require,module,exports) {
var define;
...
},{}],"6RoOu":[function(require,module,exports) {
var define;
...
},{"d3-color":"1kl75"}],"1kl75":[function(require,module,exports) {
var define;
...
},{}],"6SBVd":[function(require,module,exports) {
var define;
...
},{"d3-selection":"5pkuM","d3-dispatch":"3ftnw","d3-timer":"6PMnx","d3-interpolate":"6RoOu","d3-color":"1kl75","d3-ease":"3yJiC"}],"6PMnx":[function(require,module,exports) {
var define;
...
},{}],"3yJiC":[function(require,module,exports) {
var define;
...
},{}],"7hQoW":[function(require,module,exports) {
var define;
...
},{"d3-path":"3vIq9"}],"3vIq9":[function(require,module,exports) {
var define;
...
},{}],"1C8dn":[function(require,module,exports) {
var define;
...
},{"d3-array":"7Gn4R"}],"7KMvU":[function(require,module,exports) {
var define;
...
},{}],"3BqSm":[function(require,module,exports) {
var define;
...
},{}],"5pIjH":[function(require,module,exports) {
var define;
...
},{"d3-dsv":"3BqSm"}],"4Ooqu":[function(require,module,exports) {
var define;
...
},{"d3-quadtree":"64Qok","d3-dispatch":"3ftnw","d3-timer":"6PMnx"}],"64Qok":[function(require,module,exports) {
var define;
...
},{}],"5jKH7":[function(require,module,exports) {
var define;
...
},{}],"p8dTK":[function(require,module,exports) {
var define;
...
},{"d3-array":"7Gn4R"}],"RTbkJ":[function(require,module,exports) {
var define;
...
},{}],"1mhHE":[function(require,module,exports) {
var define;
...
},{}],"17JQ6":[function(require,module,exports) {
var define;
...
},{}],"7DG2y":[function(require,module,exports) {
var define;
...
},{"d3-array":"7Gn4R","d3-interpolate":"6RoOu","d3-format":"5jKH7","d3-time":"4tlEX","d3-time-format":"37Crq"}],"4tlEX":[function(require,module,exports) {
var define;
...
},{}],"37Crq":[function(require,module,exports) {
var define;
...
},{"d3-time":"4tlEX"}],"3Z2qd":[function(require,module,exports) {
var define;
...
},{"d3-interpolate":"6RoOu","d3-color":"1kl75"}],"1Bd3C":[function(require,module,exports) {
var define;
...
},{"d3-path":"3vIq9"}],"7FW9c":[function(require,module,exports) {
var define;
...
},{"./bundle-manifest":"5G1rV"}],"3xhgx":[function(require,module,exports) {
"use strict";
...
class Text {
  ...
  draw() {
    function gridData() {
      ...
      for (var row = 0; row < 500; row++) {
        ...
        for (var column = 0; xpos < widthW * .6; column++) {
          ...
          xpos += 6.5 * IMobj[num].length + 6; // increment the count of each square by 1

          num += 1;
        } // reset the x position after a row is complete


        xpos = 1; // increment the y position for the next row. Move it down 25 (height variable)
    ...
    var grid = d3.select("#grid").append("svg").attr("class", "gridSvg").attr("width", widthW * .7).attr("height", heightW);
    ...
    var text = row.selectAll(".label").data(function (d) {
      return d;
    }).join("svg:text").attr("class", "textWords").attr("x", function (d) {
      return d.x;
    }).attr("y", function (d) {
    ...
    d3.select("#searchButtonMobile").on("click", () => {
...
},{"d3":"7FiJ2","../style.scss":"4wf1O"}],"4wf1O":[function() {},{}],"2FcNY":[function(require,module,exports) {
"use strict";
...
class Topics {
  ...
  loadData() {
    ...
    */
    const chapterStarts = [73, 3860, 9982, 22020, 29647, 32782, 41491, 45907, 49022, 52123, 59091, 69753, 75245, 78217, 89089, 95604, 100095, 107242, 115524, 123295, 127492, 134212, 139796, 144982, 155513, 161785, 173283]; // these are chapter midpoints to align the topic model and chapters, but the beginning and end are fudged (it starts at the beginning of the prologue and ends at the end of the epilogue)
    ...
    d3.csv(this.tmResults, d => {
      d3.autoType(d);
      return { ...d,
        chapter_start: chapterStarts.shift(),
        chapter_midpoint: chapterMidpoints.shift()
      };
    }).then(data => {
      ...
      this.colorArray = ['#000', '#3cb44b', '#ffe119', '#4363d8', '#f58231', '#911eb4', '#46f0f0', '#f032e6', '#bcf60c', '#D5964D', '#fffac8', '#e6beff', '#fabebe', '#008080', '#e6194b', '#aaffc3', '#89cff0', '#ffffff', '#ffd8b1', '#000075', '#808080'];
      this.loadTextData();
    });
  ...
  initTopic() {
    ...
    this.yScale = d3.scaleLinear().domain([d3.min(this.stack, d => d3.min(d, d => d[1])), d3.max(this.stack, d => d3.max(d, d => d[1]))]).rangeRound([height - marginBottom, marginTop]);
    this.xAxis = d3.axisBottom(this.xScale).tickValues(this.topicData.map(d => d.chapter_start)).tickSize(-height).tickFormat(function (d, i) {
      return chArray[i];
    }).tickArguments([26]);
    this.yAxis = d3.axisLeft(this.yScale);
    const area = d3.area().x(d => this.xScale(d.data.chapter_midpoint)).y0(d => this.yScale(d[0])).y1(d => this.yScale(d[1]));
    const color = d3.scaleOrdinal().domain(this.stack.map(d => d.key)).range(this.colorArray).unknown("#ccc");
    this.svg = d3.select("#d3-container-TM").append("svg").attr("viewBox", [0, 0, width, height * 1.2]).attr("class", "topic");
    this.svg.attr("class", "topic").append("g").attr("transform", `translate(0, ${height - marginBottom})`).call(this.xAxis);
    d3.selectAll('path').style("opacity", .4).attr("stroke", darkDarkRed).attr('stroke-width', '.5');
    const streams = this.svg.append("g").selectAll("path").data(this.stack).join("path").attr("fill", ({
      key
    }) => color(key)).attr("d", area).attr('stroke-width', '.5').attr("stroke", palerRed).attr("class", ({
      key
    }) => key).append("title").text(({
      key
    }) => key).call(this.xAxis); //create empty topic text box

    const topic = d3.select("#d3-container-TM").append("div").attr("class", "tooltip").style("opacity", 1); // 

    const topics = this.svg.selectAll("path").on("mouseenter", function (d) {
      d3.selectAll('path').style("opacity", .4).attr("stroke", darkDarkRed).attr('stroke-width', '.5');
      d3.select(this).raise().attr('stroke-width', '3').attr("stroke", ({
        key
      }) => color(key)).style("opacity", 1).transition().duration(200);
    }).on("click", (event, d) => {
      // data is the topic data associated with an area
      const data = event.srcElement.__data__.key; // the next three lines turn the topic to strings and find those words in teh text ofr the multi-word Freq plot
      ...
      this.svg = d3.select("#d3-container-multiContext").attr("viewBox", [0, 0, width, height * 2]).attr("class", "context").text(`${topicWords.join(', ')}`); // [ ] TODO: UI to show/maintain clicked topic -- proving more challenging than expected
  ...
  newWordtoTopic(newWord) {
    ...
    const width = 800;
    const height = 50; // order topics within each chapter to get the biggest topic
    ...
    this.svg = d3.select("#d3-container-hint").attr("viewBox", [0, 0, width, height * 2]).attr("class", "context").text(textOutput(newWord));
  }

}

exports.default = Topics;
},{"d3":"7FiJ2","../../src/style.scss":"4wf1O","url:../../data/IM_19_by_20_try_2.csv":"5r1pR","url:../../data/invisible_man.txt":"1Y7wD"}],"4wf1O":[function() {},{}],"5r1pR":[function(require,module,exports) {
module.exports = require('./bundle-url').getBundleURL() + require('./relative-path')("4jSPC", "2cF7r");
},{"./bundle-url":"10N7P","./relative-path":"Q4PMS"}],"1KA0m":[function(require,module,exports) {
"use strict";
...
},{"d3":"7FiJ2","../style.scss":"4wf1O"}],"4wf1O":[function() {},{}]},{},["2XMnT","4WM95","435K3"], "435K3", null)
